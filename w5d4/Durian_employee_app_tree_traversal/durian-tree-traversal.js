...
const simone     = new Employee("Simone", "Worker", 500000);
const ali     = new Employee("Ali", "Worker", 500000);
const florida     = new Employee("Florida", "Worker", 500000);
const david     = new Employee("David", "Worker", 500000);
const brian     = new Employee("Brian", "Worker", 500000);
const karia     = new Employee("Karia", "Worker", 500000);
